...
\end{figure}
  ...
  \begin{figure}
    \centering
    \subfloat[\label{fig4a}][A simplified view of the Helical Tomotherapy 
    treatment head system in use today. The setup consists of a 6 MV linac to 
    produce an x-ray beam which is collimated down to a fan-beam using 2 
    moveable jaws (denoted as `y-jaws' in the image)]{
